...
<body>
	...
	<div class="container-contact100">
		<div class="wrap-contact200" style="background-image: url('images/predio01.jpg'); background-size: cover;">
			...
			<div class="col">
				<div class="row">
					<button class="btn btn-secondary mx-auto text-uppercase" style="width:95%" type="button" data-toggle="collapse" data-target="#collapseSaida" aria-expanded="true" aria-controls="collapseSaida">Alterar Hora de Saída</button>
				</div>
              ...
              <option value=''>Esperando informações ...</option>
						...
						<form class="contact100-form validate-form" id="barcode-saida" action="alterar_saida_update.php" method="post">
							<span class="contact100-form-title">Alterar Hora de Saída de Veículo</span>
              ...
              <div class="wrap-input100 " data-validate="Digite a data e hora de saída">
                ...
                <span class="focus-input100"></span>
							...
							<div class="wrap-input100">
								<input required id="barcode" class="input100" type="number" name="barcode">
								<span class="focus-input100"></span>
						</div>
